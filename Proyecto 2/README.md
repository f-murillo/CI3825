...
- El objetivo del proyecto es desarrollar un programa que, dada una instancia de un teatro de operaciones, verifique si los objetos OM e IC entran en los rangos explosivos de los drones, y determine cuántos son destruidos parcial o totalmente; también debe indicar cuántos no fueron afectados por ninguna explosión
